...
<!----------------------------->
  ...
  <a class="navbar-brand" href="https://cbana.us/songbook/">Falam Hymn Hla</a>
...
<div class="container mx-auto">
    ...
    <div >Key: <?= ucfirst($row['chord'])?></div><br>
    ...
    <span class = "social_logo">
      <a href='uploads/<?=$row['pdf']?>'> <img class = invert" src="uploads/icons/file-earmark-pdf.svg" alt="" width="40" height="40"></a>
      <a href='uploads/<?=$row['ppt']?>'> <img src="uploads/icons/file-earmark-ppt.svg" alt="" width="40" height="40"></a>
      <a href='uploads/<?=$row['pro']?>'> <img src="uploads/icons/file-earmark-play.svg" alt="" width="40" height="40"></a>
      </span>
      <br>
      <br>
      <br>
...
</div><div class="footer bg-light"><img src="uploads/icons/footer_logo.png"</div>
</div>
