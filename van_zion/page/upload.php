...
<body>
    ...
    <div id="wrapper">
        <form action="upload_functions.php" method="post" enctype="multipart/form-data">
            ...
            <div class="card text-white bg-primary mb-1" style="max-width: 50rem;">
                ...
                <div class="card-body">
                    <input type="file" name="pdf_file"></p>
                </div>
            </div>
            ...
            <div class="card text-white bg-danger mb-1" style="max-width: 50rem;">
                ...
                <div class="card-body">
                    <input type="file" name="pptx_file"></p>
                </div>
            </div>
            ...
            <div class="card text-white bg-dark mb-1" style="max-width: 50rem;">
                ...
                <div class="card-body">
                    <input type="file" name="pro_file"></p>
                </div>
            </div>
