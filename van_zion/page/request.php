    ...
    <div class="container mx-auto">
        <div class="row text-left">
            ...
            <div class="col-8 mx-auto">
                ...
                <form id="frmContact" action="" method="post">
                    ...
                    <div style="margin-left:290px">
                        ...
                        <input type="hidden" name="userEmail" id="userEmail" value="jsianguk@gmail.com"
                            class="inputBox">
                    </div>
                    <div>
                        <label>Hla thar hmin</label> <span id="subject-info" class="info"></span><br />
            ...
            <div class="footer mt-1">
                <div><img src="../../uploads/icons/footer_logo_hd.png" width="161" height="50">
                </div>
            </div>
        </div>
</body>
